...
import { Mail, Search, Space, UserIcon, X } from "lucide-react";
    ...
    <div className={cn("w-full max-w-2xl mx-auto", className)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-10 pr-10 h-12 text-base w-full rounded-md border border-muted bg-popover text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        />
      ...
      {/* Search Results */}
      {searchTerm.trim() && (
        <div className="mt-2 bg-card max-h-96 overflow-y-auto rounded-lg border border-border shadow-lg">
          {isLoading ? (
