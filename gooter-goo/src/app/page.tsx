        ...
        <div className="max-w-4xl space-y-8 relative">
          ...
          <div>
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-indigo-400">
              Connect Instantly
              <br />
              <span className="bg-clip-text text-transparent bg-linear-to-r from-purple-600 to-pink-600  dark:from-purple-700 dark:to-pink-400">
                Chat Smarter
              </span>
            </h1>

            <p className="text-xl max-w-2xl mx-auto leading-relaxed mt-10">
              The modern messaging platform that combines lightning-fast chat
              and crtystal clear video calls in one seamless experience
            </p>
          </div>
          ...
          <div className="w-full max-w-4xl">
            <div className="bg-background rounded-2xl border bg-gradient-to-br from-primary/5 to-primary/10 p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of users who’ve already discovered a better way
                to communicate. Start your journey with Beam today — it’s
                completely free.
              </p>
